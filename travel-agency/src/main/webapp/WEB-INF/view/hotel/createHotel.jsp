...
<div class="container">
  <form action="/adminhotel/save" method="POST">
  <center><h1>Add Hotel</h1></center>
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="hcode" name="hotelcode" placeholder="Hotel Code.."/>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <select id="htype" name="hoteltype">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="staycost" name="staycost" placeholder="Stay cost (per day)"/>
      </div>
    </div>
